...
class ElchPlot(FigureCanvasQTAgg):
    def __init__(self):
        ...
        ax.set_xticklabels(range(10), fontproperties=fm.FontProperties(fname='Fonts/Roboto-Light.ttf', size=11))
        ax.set_yticklabels(range(10), fontproperties=fm.FontProperties(fname='Fonts/Roboto-Light.ttf', size=11))
        ax2.set_yticklabels(range(10), fontproperties=fm.FontProperties(fname='Fonts/Roboto-Light.ttf', size=11))
