...
class ResistiveHeaterConfig:
    ...
    def to_config_parser(self, parser: ConfigParser, section: str) -> None:
        parser[section] = {"P":     str(self.pid.p), "I": str(self.pid.i), "D": str(self.pid.d),
                           "Rate":  str(self.control.rate), "R_cold": str(self.heater.r_cold),
                           "U_max": str(self.heater.max_voltage), "I_max": str(self.heater.max_current),
                           "P_min": str(self.heater.min_output), "Offset": str(self.material.offset),
                           "Slope": str(self.material.slope)}
